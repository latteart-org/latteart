import { JSTestSuiteCommentGenerator } from "@/lib/operationHistory/scriptGenerator/codeGenerator/js/testSuite/JSTestSuiteCommentGenerator";
import { ScreenTransitionDiagram } from "@/lib/operationHistory/scriptGenerator/docGenerator/screenTransitionDiagram/ScreenTransitionDiagram";
