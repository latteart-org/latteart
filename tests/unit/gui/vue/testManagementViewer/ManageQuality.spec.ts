...
describe("ManageQualityView.vueは", () => {
  ...
  describe("groupsプロパティのgetterが呼ばれたとき", () => {
    it("グループフィルタを掛けていない場合、全てのgroupが取得できること", () => {
      const testMatrixId = "m000";
      const $route = { params: { testMatrixId } };
      const vm = shallowMount(ManageQualityView, {
        localVue,
        router,
        store,
        mocks: { $route },
  ...
  describe("testTargetsプロパティのgetterが呼ばれたとき", () => {
    it("グループフィルタを掛けていない場合、全てのtestTargetが取得できること", () => {
      const testMatrixId = "m000";
      const $route = { params: { testMatrixId } };
      const vm = shallowMount(ManageQualityView, {
        localVue,
    ...
    it("グループフィルタを掛けている場合、対象のgroupに紐づいているtestTargetのみが取得できること", () => {
      const testMatrixId = "m000";
      const $route = { params: { testMatrixId } };
      const vm = shallowMount(ManageQualityView, {
        localVue,
  ...
  describe("itemsプロパティのgetterが呼ばれたとき", () => {
    it("全件数が選択されている場合、全てのバグ起票件数が取得できること", () => {
      const testMatrixId = "m000";
      const $route = { params: { testMatrixId } };
      const vm = shallowMount(ManageQualityView, {
        localVue,
    ...
    it("1セッションあたりの件数が選択されている場合、バグ起票件数/完了済みセッション数の形式で取得できること", () => {
      const testMatrixId = "m000";
      const $route = { params: { testMatrixId } };
      const vm = shallowMount(ManageQualityView, {
        localVue,
    ...
    it("グループフィルタを掛けている場合、対象のグループのみの値が取得出来ること", () => {
      const testMatrixId = "m000";
      const $route = { params: { testMatrixId } };
      const vm = shallowMount(ManageQualityView, {
        localVue,
    ...
    it("テスト対象フィルタをかけている場合、対象のテスト対象のみの値が取得できること", () => {
      const testMatrixId = "m000";
      const $route = { params: { testMatrixId } };
      const vm = shallowMount(ManageQualityView, {
        localVue,
