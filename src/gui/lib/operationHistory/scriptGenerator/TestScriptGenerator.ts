...
import { CombinationGenerator } from "./testDataRepository/CombinationGenerator";
import { CombinationTestDataSelector } from "./testDataRepository/CombinationTestDataSelector";
import { PageObject } from "./model/pageObject/PageObject";
import { TemplateTestDataSelector } from "./testDataRepository/TemplateTestDataSelector";
import { TestDataSelector } from "./testDataRepository/TestDataSelector";
...
} from "./model/TestScriptModelGeneratorFactory";
import { MethodCall, TestSuite } from "./model/testSuite/TestSuite";
import { TestDataSet } from "./testDataRepository/TestDataSet";
import { Operation } from "../Operation";

export interface TestScriptGenerator {
  generate(sources: { initialUrl: string; history: Operation[] }[]): TestScript;
}

export class TestScriptGeneratorImpl implements TestScriptGenerator {
  constructor(
