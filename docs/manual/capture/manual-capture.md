...
直近の操作やコメントを基にテストヒントを検索した結果はマッチング結果として（マッチング数/全テストヒント数）で表示されています。  
...
- ヒント本文・キーワードが有効の場合、ヒント本文・キーワード欄を基に登録済みのテストヒントを検索します。
  ...
  - :bulb: 検索対象のヒント本文・キーワードはテストヒント設定を基にコメントを取得し、自動補完して検索します。「自動補完」についての詳細は「[テストヒント設定](../others/manual-config.md/#テストヒント設定)」をご参照ください。
