...
押下すると記録されているテスト履歴をクリアします。新規のテストを行いたい場合等に使用してください。
...
<img src="./images/test-result-summary.png"/>　
...
<img src="./images/edit-test-result-name-button.png"/>　　

「テスト結果名編集ボタン」を押下するとテスト結果名変更モードとなり、変更して再度「テスト結果名編集ボタン」を押下するとテスト結果名を変更することができます。
