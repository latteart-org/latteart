...
<img src="images/snapshot-button.png" />

押下すると、すべてのテスト計画やセッションのスナップショットが zip ファイルとして出力されます。
...
- データ駆動方式を使用する
  - チェックを入れると、 `test_data/TestData.js` に定義されたデータを入力値とするテストケースを生成します。
...
- テストアイテム
  - テスト時にテスト実施者が使用する資材(操作説明書等)を記載してください。
- テスター名
  - テスト実施者の名前を記載してください。
- メモ
  - セッションを行う際に特に注意すべき点がある場合等、テスト実施者へのより細かい指示を記載してください。

### レポート部

<img src="images/report.png" />

テスト結果の読み込み、テスト証跡等のファイルの添付や、テスト実施者が実際に挙げた気づきをバグトラッキングシステム等に起票するか選択することができます。
...
- テスト中の気づき
  ...
  - 各気づきは「起票状態」欄でバグトラッキングシステム等に起票するかを選択することができ、「バグ票番号」でその際バグ番号を指定することができます。
