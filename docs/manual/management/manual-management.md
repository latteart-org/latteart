...
「選択」ボタンを押下するとファイル選択ダイアログが表示され、プロジェクト情報、テスト結果情報のチェックボックスでインポート対象を選択可能です。  
...
<img src="images/setting-import-dialog.png" />

「選択」ボタンを押下するとファイル選択ダイアログが表示され、インポートファイルを選択できます。  
OK ボタンを押下し、設定がインポートされます。

:bulb: json ファイル名の指定は自由となります。

#### 設定のエクスポート

オプション機能の一覧から押下すると現在の設定をエクスポートすることができます。
