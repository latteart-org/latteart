...
また、ストーリーを開いた履歴を過去 5 つ分、左側のメニューバーに「最近読み込んだストーリー」欄に表示されるため、テストマトリクス確認画面からストーリーを開くことなく、ショートカットとしてストーリー編集画面を表示することができます。
...
- テスト実行モデル
  ...
  - セッションに紐づけたテスト結果を新規作成することができます。
    - 「新規テストを開始」ボタンから新規でテスト結果を作成し、履歴画面を表示することができます。
  - 記録されたテスト結果を複数読み込むことができます。
...
また、レビューを行っている間、左側のメニューバーに「現在のレビュー」欄にレビュー画面へのショートカットメニューが表示されるため、ストーリー編集画面など別画面と行き来しながらレビューを行うことができます。
...
テストマトリクスが 1 つ以上作成されている場合のみボタンが活性化されます。
...
「選択」ボタンを押下するとファイル選択ダイアログが表示され、プロジェクト情報、テスト結果情報、設定情報のチェックボックスでインポート対象が選択できます。  
...
プロジェクト情報、テスト結果情報、設定情報のチェックボックスでエクスポート対象が選択できます。
