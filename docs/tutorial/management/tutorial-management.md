...
- 解凍したファイル内の下図赤枠で囲まれた`manage.bat`をダブルクリックします。
...
- テスト対象機能を入力し、「追加」ボタンを押下してテスト対象を追加します。
...
- 管理ツールから新規でテスト結果を作成する場合は「記録ツール起動」から記録ツールを起動し、テストを実行します。
...
上記を実行すると以下のようになります。　　
記録ツールでテスト結果を開くボタンを押下すると取り込んだテスト結果を記録ツールで表示できます。また、再読込ボタンを押下すると、テスト結果名とテスト実行時間に変更があった場合に最新化、ゴミ箱ボタンを押下すると、取り込んだテスト結果をセッションから除外します。なお、テスト結果そのものは削除されません。
...
- 「設定・プロジェクトのインポート」をクリックすると、プロジェクト情報・テスト結果情報・設定情報をインポートします。
...
- 「設定・プロジェクトのエクスポート」をクリックすると、プロジェクト情報・テスト結果情報・設定情報をエクスポートします。
