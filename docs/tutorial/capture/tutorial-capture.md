...
- テスト記録開始画面で必要情報を記載し、テストを開始します。
  ...
  - メディアタイプを静止画、動画、静止画＋動画のいずれかを選択してください。
...
- テスト目的に沿ったテストが一区切りついた時や、違和感のある動作を見つけた場合は、LatteArt のフッターの以下ボタンから気づきを記録することができます。

<div align="center">
<img src="./images/add-note-button.png"/>
</div><br>

- ボタンを押下すると以下のダイアログが表示され、気づきを入力できます。
