...
export class AddTestDesignSupport1721721469884 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "TEST_HINT_PROPS" ("id" varchar PRIMARY KEY NOT NULL, "name" varchar NOT NULL, "type" varchar NOT NULL, "list_items" varchar NOT NULL, "index" integer NOT NULL)`);
