  ...
  implements MigrationInterface
{
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP INDEX "IDX_efbdded2c32167debc35d62219"`);
    await queryRunner.query(
      `ALTER TABLE "TESTRESULT_SESSION_RELATIONS" RENAME TO "temporary_TESTRESULT_SESSION_RELATIONS"`
    );
    await queryRunner.query(
      `CREATE TABLE "TESTRESULT_SESSION_RELATIONS" ("test_result_id" varchar NOT NULL, "session_id" varchar NOT NULL, PRIMARY KEY ("test_result_id", "session_id"))`
    );
    await queryRunner.query(
      `INSERT INTO "TESTRESULT_SESSION_RELATIONS"("test_result_id", "session_id") SELECT "test_result_id", "session_id" FROM "temporary_TESTRESULT_SESSION_RELATIONS"`
    );
    await queryRunner.query(
      `DROP TABLE "temporary_TESTRESULT_SESSION_RELATIONS"`
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_5587ef5339b22cb7f5227a1348" ON "TESTRESULT_SESSION_RELATIONS" ("session_id") `
    );
    ...
    await queryRunner.query(
      `INSERT INTO "SESSIONS"("session_id", "testUser", "name", "index", "memo", "test_item", "done_date", "story_id") SELECT "session_id", "testUser", "name", "index", "memo", "test_item", "done_date", "story_id" FROM "temporary_SESSIONS"`
    );
    ...
    await queryRunner.query(
      `CREATE TABLE "SESSIONS" ("session_id" varchar PRIMARY KEY NOT NULL, "testUser" varchar NOT NULL, "name" varchar NOT NULL, "index" integer NOT NULL, "memo" varchar NOT NULL, "test_item" varchar NOT NULL, "testing_time" integer NOT NULL, "done_date" varchar NOT NULL, "story_id" varchar, "test_result_id" varchar, CONSTRAINT "FK_4761b86c592e4826f029d4f702e" FOREIGN KEY ("test_result_id") REFERENCES "TEST_RESULTS" ("test_result_id") ON DELETE SET NULL ON UPDATE NO ACTION, CONSTRAINT "FK_5127b300c99c5030df3036fb12f" FOREIGN KEY ("story_id") REFERENCES "STORIES" ("story_id") ON DELETE CASCADE ON UPDATE NO ACTION)`
    );
    await queryRunner.query(
